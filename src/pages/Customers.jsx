...
const Customers = () => {
  ...
  const CustomerCard = ({ customer }) => (
    <div className="bg-white dark:bg-dark-800 p-6 rounded-xl shadow-sm border border-gray-200/80 dark:border-dark-700 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center space-x-3">
          <div
            className="w-12 h-12 rounded-full flex items-center justify-center text-white font-semibold bg-gradient-to-br"
            style={{
  ...
  const avgOrderValue =
    ...
    customersData.reduce((sum, c) => sum + c.totalOrders, 0) > 0
      ? (
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 my-4">
        <div className="flex items-center bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl shadow p-4 space-x-3 text-white">
          ...
          <div>
            ...
            <div className="text-2xl font-semibold">{customersData.length}</div>
          </div>
        </div>
        <div className="flex items-center bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl shadow p-4 space-x-3 text-white">
          ...
          <div>
            <div className="text-sm font-medium">VIP Customers</div>
        ...
        <div className="flex items-center bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl shadow p-4 space-x-3 text-white">
          ...
          <div>
            ...
            <div className="text-2xl font-semibold">₽{Number(avgOrderValue).toLocaleString('ru-RU')}</div>
          </div>
        </div>
        <div className="flex items-center bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-xl shadow p-4 space-x-3 text-white">
          <div className="p-3 rounded-full bg-white/20">
      ...
      {/* Add Customer Modal (simple placeholder, non-functional for now) */}
      {showAddModal && (
