...
const Settings = () => {
  const { user, theme, toggleTheme, setUserAvatar } = useStore();
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            <button
              ...
              className="px-4 py-2 rounded-lg transition-colors text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500"
            >
              Change Picture
            </button>
            <input
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Two-Factor Authentication</h3>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <button className="px-4 py-2 rounded-lg transition-colors text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500">
              Enable
            </button>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Manage your account settings and preferences for this dashboard
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-dark-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-dark-700">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 dark:border-dark-700 flex items-center justify-between">
              <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span>Changes apply to your account only.</span>
              </div>
              <button
                onClick={handleSave}
                className="px-6 py-2 rounded-lg flex items-center space-x-2 transition-colors text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500"
              >
