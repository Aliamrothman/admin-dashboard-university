...
import { Plus, X, CalendarDays, Clock3, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-dark-800 p-6 rounded-xl w-96 shadow-lg border border-gray-200 dark:border-dark-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                <button
                  type="submit"
                  className="flex-1 px-3 py-2 rounded-lg transition-colors text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500"
                >
                  Add Event
                </button>
                <button
                  ...
                  className="flex-1 bg-gray-500 hover:bg-gray-600 text-white py-2 rounded-lg transition-colors text-sm font-medium"
                >
                  Cancel
                </button>
              </div>
